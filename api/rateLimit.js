 ...
 */
async function checkRateLimitRedis(key, config = DEFAULT_CONFIG) {
 ...
 */
function checkRateLimitInMemory(key, config = DEFAULT_CONFIG) {
  const now = Date.now();
 ...
 */
export async function checkRateLimit(identifier, config = DEFAULT_CONFIG) {
