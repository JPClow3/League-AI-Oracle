...
export const useCommands = ({
    ...
    return useMemo(() => {
        ...
        const actionCommands: Command[] = [
            ...
            { id: 'action-open-settings', title: 'Open Settings', section: 'Actions', action: () => dispatch({ type: 'OPEN_SETTINGS_PANEL' }) },
            { id: 'action-give-feedback', title: 'Give Feedback', section: 'Actions', action: () => dispatch({ type: 'OPEN_FEEDBACK' }) },
        ];
    ...
    }, [championsLite, setCurrentPage, resetDraft, resetArena, resetLiveDraft, dispatch, setStrategyHubInitialTab, setStrategyHubInitialSearch]);
};