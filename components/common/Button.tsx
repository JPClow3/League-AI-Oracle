...
export const Button = ({ children, variant = 'primary', className = '', ...props }: ButtonProps) => {
  const baseClasses = 'font-semibold transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[hsl(var(--focus-ring))] focus-visible:ring-offset-[hsl(var(--bg-primary))] disabled:cursor-not-allowed active:scale-[0.98] transform hover:scale-[1.02]';
