...
export const SkeletonCard = ({ className = '' }: SkeletonProps) => (
    <div className={`p-4 border border-border-primary rounded-md space-y-3 ${className}`} role="status" aria-label="Loading card...">
 ...
 */
export const SkeletonChampionGrid = ({ 
    count = 12, 
    className = '' 
}: { 
    count?: number; 
    ...
    <div className={`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 ${className}`} role="status" aria-label="Loading champions...">
...
export const SkeletonAnalysisPanel = ({ className = '' }: SkeletonProps) => (
    <div className={`p-6 border border-border-primary rounded-md space-y-4 ${className}`} role="status" aria-label="Loading analysis...">
...
export const SkeletonTable = ({ 
    ...
    <div className={`border border-border-primary rounded-md overflow-hidden ${className}`} role="status" aria-label="Loading table...">
        {/* Header */}
