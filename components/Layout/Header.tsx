...
import { User, Settings, Component, Menu, X, HelpCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => setCurrentPage('Home')} className="flex items-center gap-2 group">
            ...
            <span className="font-display font-semibold text-xl text-[hsl(var(--text-primary))] tracking-wider hidden sm:block">
              DraftWise
            </span>
          </button>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Tooltip content={`Level ${profile.level}: ${profile.sp} / ${spForNextLevel} SP`}>
            <button
              ...
              className="relative min-w-[44px] min-h-[44px] w-10 h-10 flex items-center justify-center text-[hsl(var(--text-secondary))] hover:bg-[hsl(var(--surface))] hover:text-[hsl(var(--text-primary))] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
          ...
          <Tooltip content={t('header_settings')}>
            <button
              ...
              className="p-2 min-w-[44px] min-h-[44px] text-[hsl(var(--text-secondary))] hover:bg-[hsl(var(--surface))] hover:text-[hsl(var(--text-primary))] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
