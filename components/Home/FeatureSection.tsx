...
export const FeatureSection = ({ setCurrentPage, navigateToArmory }: FeatureSectionProps) => {
  ...
  const coreTools = [
    ...
    },
    {
      ...
      description:
        'Let the AI guide you step-by-step in creating a powerful composition around a core champion or strategy.',
      icon: ICONS.BUILDER,
  ...
  const learning = [
    ...
    },
    {
      ...
      description:
        'Test your knowledge in specific, tricky draft situations and get instant AI feedback on your choices.',
