  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4 bg-surface border border-border p-4 shadow-lg">
        ...
        <div>
          <h1 className="font-display text-3xl font-bold text-text-primary">Oracle</h1>
          <p className="text-sm text-text-secondary">
            Consult the All-Seeing Eye. Ask any question about the meta and receive an answer grounded in the latest
            data.
          </p>
        </div>
      </div>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {EXAMPLE_PROMPTS.map(prompt => (
                <button
                  ...
                  aria-label={`Use example query: ${prompt}`}
                >
                  &quot;{prompt}&quot;
                </button>
              ))}
