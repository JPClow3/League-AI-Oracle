...
export const PlaylistViewer = ({ playlist, completedLessons, onSelectLesson, onClose }: PlaylistViewerProps) => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <h2 id="empty-playlist-title" className="text-xl font-bold text-text-primary mb-2">
            No Lessons Available
          </h2>
          <p id="playlist-description" className="text-text-secondary mb-4">
        ...
        <div className="p-6 border-b border-border-primary">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-text-primary mb-2">{playlist.title}</h2>
              <p className="text-text-secondary mb-3">{playlist.description}</p>
              <div className="flex flex-wrap gap-3 text-sm">
                ...
                {playlist.role && <span className="text-accent">Role: {playlist.role}</span>}
          ...
          <div className="mt-4 flex gap-2">
            <Button variant="primary" onClick={handleStartPlaylist} className="flex items-center gap-2">
              <PlayCircle size={18} />
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                        isCompleted ? 'bg-success/20 text-success' : 'bg-surface-secondary text-text-secondary'
                      }`}
                    >
                      {isCompleted ? (
                        <CheckCircle size={18} />
