    ...
    return (
        <div className="flex flex-col h-full">
            <div className="border-b border-border flex items-center gap-4">
                 <TabButton tabName="champions" currentTab={activeTab} setActiveTab={setActiveTab}>Champion Dossiers</TabButton>
                 <TabButton tabName="intel" currentTab={activeTab} setActiveTab={setActiveTab}>Meta Intelligence</TabButton>
            </div>
