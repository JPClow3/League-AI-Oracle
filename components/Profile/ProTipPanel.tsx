    ...
    return [
      {
        ...
        action: () => {
          const missionsPanel =
            document.getElementById('missions-panel') || document.getElementById('missions-panel-mobile');
      ...
      },
      {
        ...
        condition: () =>
          Boolean(lastFeedback && lastFeedback.type === 'lesson' && lastFeedback.message.includes('weakness')),
      ...
      },
      {
        ...
        actionText: 'Go to Armory',
        action: () => setCurrentPage('Armory'),
      },
      {
        id: 'low-arena-score',
        ...
        description:
          "Your Arena scores suggest there's room to grow! Mastering team composition archetypes is a great place to start.",
        actionText: 'Go to Academy',
      ...
      },
      {
        ...
        title: 'Build Your Archives',
        description:
          'Saving successful drafts to your Archives is key to building a strategic library you can rely on.',
      ...
      },
      {
        ...
        description:
          'Try analyzing drafts with different champions in the Strategy Forge to increase your mastery and strategic flexibility.',
        actionText: 'Go to Forge',
        action: () => setCurrentPage('Strategy Forge'),
      },
    ];
