...
export const TeamPanel: React.FC<TeamPanelProps> = ({ side, state, onSlotClick, activeSlot, onTeamUpdate }) => {
  ...
  const gradient = isBlue
    ? 'from-slate-900 to-blue-900/30'
    : 'from-slate-900 to-red-900/30';
  ...
  return (
    <div className={`bg-gradient-to-br ${gradient} p-4 rounded-xl shadow-lg border ${borderColor}`}>
      ...
      <div className="space-y-4">
        ...
        {/* Picks Section */}
        <div>
          <h3 className="text-lg font-semibold text-gray-300 mb-2 text-center">Picks</h3>
        ...
        {/* Bans Section */}
        <div>
          <h3 className="text-lg font-semibold text-gray-300 mb-2 text-center">Bans</h3>
